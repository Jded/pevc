...
export class HarvesterE31 implements DistortionMode {
  ...
  distortModel(model: PlateService, time: number) {
    ...
    const cepsilon = model.material.c[0][0] * model.material.epsilon[2][2] * Math.pow(10, Constants.C_EXP + Constants.EPSILON_EXP);
